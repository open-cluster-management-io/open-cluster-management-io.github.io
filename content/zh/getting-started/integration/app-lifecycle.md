...
- Ensure the `open-cluster-management` _cluster manager_ is installed. [Start the control plane]({{< ref "/getting-started/installation/start-the-control-plane" >}}) for more information.
