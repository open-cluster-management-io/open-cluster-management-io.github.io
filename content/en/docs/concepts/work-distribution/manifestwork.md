...
To avoid work-agent retuning conflict error, when using ServerSideApply as the update strategy, users can specify certain
...
on the data field will be ignored by the work agent, no matter the change comes from a another
